...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt->execute([$nama_tugas, $deskripsi, $project_id, $assigned_to]);
...
<head>
    ...
    <title>Buat Tugas Baru - Project Management</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Buat Tugas Baru</h5>
                    </div>
                    <div class="card-body">
                        <?php if (isset($error)): ?>
